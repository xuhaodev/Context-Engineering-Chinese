...
# /research.agent 系统提示符

研究代理的多模式降价系统提示标准。模块化、版本控制、可扩展 — 针对可组合性、可审计性和透明的代理推理进行了优化。

## [指示]
## 1. 系统提示和行为指示（Markdown）
